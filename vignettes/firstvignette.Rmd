...
aln <- readDNAStringSet('~/Downloads/combined/YBR013C/YBR013C_alignment.fa')
...
```{r subalignment}
  dnalist <- align(aln,'YBR013C', '../../synal_deneme/',ygene)
...
vec <- c(1,1,0,0,0,0)
types <- types[vec>0]
findHomolog(DNAStr[vec>0], aa_alignment[vec>0], start, stop, ygene, types,  '../../synal_deneme/', 'YBR013C')
